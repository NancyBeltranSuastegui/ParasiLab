<?php
	...
	$controllers= array(
						'inicio'=>['inicio'],
						'usuario'=>['inicio', 'login', 'logout','register','update', 'delete', 'registrahotel', 'validar', 'mishoteles', 'hotel', 'admtema', 'admlaberinto', 'admcrucigrama', 'admmemorama', 'admrompecabeza', 'admsopa'],
						'hotel'=>['inicio', 'back', 'publicar', 'see'],
